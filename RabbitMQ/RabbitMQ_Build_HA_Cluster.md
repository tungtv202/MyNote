...
- Khi 1 node fail, xong quay lại, thì nó chỉ đồng bộ các message mới. Mà không phải sync lại từ đầu. Và quá trình sync các message mới này không bị blockking.
